    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse move-me">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="addclassrooms.php">ADD LECTURE HALL</a></li>
...
<div align="center"
     style="margin-top:10%">
    <button
        id="classroommanual" class="btn btn-success btn-lg">ADD LECTURE HALL
    </button>
</div>
...
<script>
    ...
    let addclassroomBtn = document.getElementById("classroommanual");
    let heading = document.getElementById("popupHead");
    let classroomForm = document.getElementById("addClassroomForm");
...
<script>
    function deleteHandlers() {
        let table = document.getElementById("classroomstable");
        let rows = table.getElementsByTagName("tr");
        for (i = 0; i < rows.length; i++) {
            let currentRow = table.rows[i];
            //var b = currentRow.getElementsByTagName("td")[0];
            let createDeleteHandler =
                function (row) {
                    return function () {
                        let cell = row.getElementsByTagName("td")[0];
     S                   let id = cell.innerHTML;
                        let x;
...
<div align="center">
    ...
    <table id=classroomstable>
        <caption><strong>ADDED LECTURE HALLS</strong></caption>
        <tr>
