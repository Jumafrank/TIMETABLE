                ...
                <form action="addsubjectFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="subjectdepartment" name="SD">
                            <option selected disabled>Select</option>
                            <option value="ICT & Computer Engg."> ICT &Computer Engg.</option>
...
<script>
    ...
    let addsubjectBtn = document.getElementById("subjectmanual");
    let heading = document.getElementById("popupHead");
    let subjectForm = document.getElementById("addSubjectForm");
