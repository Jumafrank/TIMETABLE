...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/building.jpg" alt="image">
        </div>

        <div class="item">
            <img src="assets/img/images2.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/images1" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/images4.jpg" alt="Flower">
        </div>
    </div>
</div>
...
<div align="center">
    <form data-scroll-reveal="enter from the bottom after 0.2s" action="studentvalidation.php" method="post">
        <select id="select_semester" name="select_semester" class="list-group-item">
            ...
            <option value="3"> BBIT II Year ( Semester III )</option>
            <option value="4"> BBIT II Year ( Semester IV )</option>
            <option value="5"> BBIT III Year ( Semester V )</option>
            <option value="6"> BBIT III Year ( Semester VI )</option>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    ...
                    <hr/>
                    <h4 align="center">Chancellor: Zetech University<br>Prof Susan Alfano,PhD <br> </h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">DANIEL NJERU</h3>
                    <hr/>
                    <h4 align="center">H.O.D<br/>Computer Engineering Department</h4>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4>Nairobi - Kenya</h4>
                <h4><strong>Call:</strong> +254719034500S </h4>
                <h4><strong>Email: </strong>info@zetech.ac.ke</h4>
            </div>
